...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/images/images/20.ico"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actAbout->setToolTip(QApplication::translate("QWMainWind", "\345\205\263\344\272\216\346\234\254\347\250\213\345\272\217", Q_NULLPTR));
        ...
        menu_4->setTitle(QApplication::translate("QWMainWind", "\345\270\256\345\212\251", Q_NULLPTR));
    } // retranslateUi
